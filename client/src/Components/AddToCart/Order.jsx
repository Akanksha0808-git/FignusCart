...
function Order() {
  ...
  // const cart2 = select.map((item) => ({
  //   ...item,
  //   price: item.price ? parseInt(item.price.replace(/\s/g, "").replace(/[^\d]/g, ""), 10).toString().slice(2, 10) : 0,
  //   brandPrice: item.brandPrice ? parseInt(item.brandPrice.replace(/\s/g, "").replace(/[^\d]/g, ""), 10) : 0,
  // }));
  // const cart2 = select.map((item) => ({
  //   ...item,
  //   price: parseInt(item.price.replace(/\s/g, "").replace(/[^\d]/g, ""), 10) || 0,
  // }));
  const cart2 = select.map((item) => ({
    ...item,
